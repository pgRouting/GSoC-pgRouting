...
SELECT set_eq('edgeColoring3', $$VALUES (7, 2)$$, '6: Edge formed by connecting vertices 8 and 5, is colored with color 2');
...
SELECT set_eq('edgeColoring4', $$VALUES (1, 3), (2, 2)$$,
    '8: Edge (1, 2) is colored with color 3 and Edge (2, 3) is colored with color 2');
...
SELECT set_eq('edgeColoring5', $$VALUES (1, 3), (2, 2), (3, 3)$$,
    '10: Edge (1, 2) is colored with color 3, Edge (2, 3) is colored with color 2 and Edge (3, 4) is colored with color 3');
...
SELECT set_eq('edgeColoring6', $$VALUES (8, 1), (10, 5), (11, 5), (12, 3)$$,
    '12: Edge (5, 6) is colored with color 1, Edge (5, 10) is colored with color 5, Edge (6, 11) is colored with color 5 and Edge (10, 11) is colored with color 3');
...
SELECT set_eq('edgeColoring8', $$VALUES (1, 1), (2, 2), (3, 1), (4, 2), (5, 3)$$,
    '16: Edge (1, 2) is colored with color 1, Edge (2, 3) is colored with color 2, Edge (3, 4) is colored with color 1, Edge (4, 5) is colored with color 2 and Edge (5, 1) is colored with color 3');

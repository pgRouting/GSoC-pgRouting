...
PREPARE mycoloring1 AS
SELECT *
FROM pgr_mycoloring(
    'q1'
);

SELECT is_empty('mycoloring1', '2: Graph with 0 edge and 0 vertex -> Empty row is returned');
...
PREPARE mycoloring2 AS
SELECT *
FROM pgr_mycoloring(
    'q2'
);
SELECT is_empty('mycoloring2', '4: One vertex graph can not be mycoloring-> Empty row is returned');
...
PREPARE mycoloring3 AS
SELECT *
FROM pgr_mycoloring(
    'q3'
);

SELECT set_eq('mycoloring3', $$VALUES (8, 0), (5, 1)$$, '6: Graph is bi-partite');
...
PREPARE mycoloring4 AS
SELECT *
FROM pgr_mycoloring(
    'q4'
);

SELECT set_eq('mycoloring4', $$VALUES (1, 0), (2, 1), (3, 0)$$, '8: Bi-partite graph with 3 vertices');
...
PREPARE mycoloring5 AS
SELECT *
FROM pgr_mycoloring(
    'q5'
);

SELECT set_eq('mycoloring5', $$VALUES (1, 0), (2, 1), (3, 0), (4, 1)$$, '10: Bi-partite graph with 4 vertices');
...
PREPARE mycoloring6 AS
SELECT *
FROM pgr_mycoloring(
    'q6'
);

SELECT set_eq('mycoloring6', $$VALUES (5, 0), (6, 1), (10, 1), (11, 0)$$, '12: Cyclic and mycoloring graph');
...
SELECT is_empty('mycoloring7', '14: Graph with odd lenght cycle -> Empty row is returned');

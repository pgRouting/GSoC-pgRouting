...
BEGIN
  ...
  RETURN QUERY
  SELECT has_function('vrp_vroom', ARRAY['text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text']);
  RETURN QUERY
  SELECT function_returns('vrp_vroom', ARRAY['text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text'], 'setof record');
  ...
  SELECT set_eq(
    ...
    $$VALUES
      ('{25,25,25,25,25,25,25,25,25,20,20,20,20,23,20,23,23,23,23,1016}'::OID[])
    $$
  );
  ...
  RETURN QUERY
  SELECT has_function('vrp_vroomshipments', ARRAY['text', 'text', 'text', 'text', 'text', 'text', 'text']);
  RETURN QUERY
  SELECT function_returns('vrp_vroomshipments', ARRAY['text', 'text', 'text', 'text', 'text', 'text', 'text'], 'setof record');
  ...
  SELECT set_eq(
    ...
    $$VALUES
      ('{25,25,25,25,25,25,25,20,20,20,20,23,20,23,23,23,23,1016}'::OID[])
    $$
  );
END;
$BODY$

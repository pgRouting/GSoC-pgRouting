...
* **Supported versions:**
  `Latest <https://docs.pgrouting.org/latest/en/pgr_ithBandwidth.html>`__
  (`3.4 <https://docs.pgrouting.org/3.4/en/pgr_ithBandwidth.html>`__)

pgr_ithBandwidth - Experimental
===============================================================================

``pgr_ithBandwidth`` — Returns the ith-bandwidth of each vertex of an undirected
graph.
...
.. index::
    single: ithBandwidth - Experimental on v3.4

.. parsed-literal::

    pgr_ithBandwidth(`Edges SQL`_)

    RETURNS SET OF (node, ithBandwidth)
    OR EMPTY SET

...
#ifndef INCLUDE_COLORING_PGR_EDGECOLORING_DRIVER_HPP_
#define INCLUDE_COLORING_PGR_EDGECOLORING_DRIVER_HPP_
#pragma once
...
class Pgr_Bipartite : public pgrouting::Pgr_messages {
 public:
            ...
            std::vector<pgr_vertex_color_rt> print_Bipartite(
                    G &graph) {
            ...
            std::vector<pgr_vertex_color_rt> pgr_bipartite(
                    G &graph ){
                std::vector<pgr_vertex_color_rt> results;
...
#endif  // INCLUDE_COLORING_PGR_EDGECOLORING_DRIVER_HPP_

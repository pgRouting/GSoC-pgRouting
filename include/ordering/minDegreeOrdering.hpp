...
class MinDegreeOrdering : public Pgr_messages {
 public:
    ...
    /** @name MinDegreeOrdering
      ...
      *
      * @see [boost::minimum_degree_ordering]
      * (https://www.boost.org/libs/graph/doc/minimum_degree_ordering.html)
      */
        ...
        auto out_deg = boost::make_out_degree_map(graph.graph);
         ...
         try {
             boost::minimum_degree_ordering(graph.graph, inv_perm.rbegin(), color_map, out_deg);

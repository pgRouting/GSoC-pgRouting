...
void pgr_process_coreNumbers(
        ...
        CoreNumbers_rt **result_tuples, size_t *result_count) {
    pgassert(edges_sql);
    ...
    pgrouting::drivers::do_coreNumbers(
            std::string(edges_sql),
            (*result_tuples), (*result_count),
            log, notice, err);
    time_msg(" processing pgr_coreNumbers", start_t, clock());

...
process(
        ...
        pgr_edge_color_rt **result_tuples,
        size_t *result_count) {
    pgr_SPI_connect();
...
PGDLLEXPORT Datum _pgr_edgecoloring(PG_FUNCTION_ARGS) {
    ...
    /**********************************************************************/
    pgr_edge_color_rt *result_tuples = NULL;
    ...
    result_tuples = (pgr_edge_color_rt*) funcctx->user_fctx;
    ...
    if (funcctx->call_cntr < funcctx->max_calls) {
        ...
        values[0] = Int64GetDatum(result_tuples[funcctx->call_cntr].edge);

...
PGDLLEXPORT Datum _pgr_mycoloring(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(_pgr_mycoloring);
...
process(char* edges_sql,
    ...
    time_msg("processing pgr_mycoloring()", start_t, clock());

 ...
 * in C types. Then it calls the function `do_pgr_vertexBetweennessCentrality` defined
 * in the `vertexBetweennessCentrality_driver.h` file for further processing.
